...
{-# LANGUAGE UndecidableInstances, PackageImports, NoImplicitPrelude #-}
...
import           Data.Word
-- import           Text.Megaparsec (ParseError(..), parseErrorPretty, Stream, ShowErrorComponent, ShowToken)
...
-- instance (Stream t, Ord t, ShowErrorComponent e, ShowToken t) => Pretty (ParseError t e) where
--   prettyPrec _ = text . parseErrorPretty
